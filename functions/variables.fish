...
#I created a fish function to load my local variables not putting them on git
if test -e $HOME/.config/fish/functions/load_env_local_variables.fish
  load_env_local_variables
end
